...
impl LinuxAgentScraper {
    pub(crate) fn new(args: Arc<CliArgs>, cluster_aggregator_client: Client) -> LinuxAgentScraper {
        LinuxAgentScraper {
...
impl Scraper for LinuxAgentScraper {
    ...
    /// leaving these tasks for cluster-aggregator (and later, Checkmk itself)
    /// to do.
