...
macro_rules! define_reflectors {
    (
        ...
        /// The [`Store`]s where all of the watched Kubernetes kinds that the
        /// agent monitors end up.
        ///
        /// The stores here are not frozen and might update in the background at
        /// any time.
        #[derive(Clone)]
        pub struct Stores {
